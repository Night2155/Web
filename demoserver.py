...
def home():
    return render_template('show_all_data.html', vc_id=VC_id.query.all(), v_keywords=V_keywords.query.all())
...
def search():
    ...
    keywords = "時態"  # 網站傳來的關鍵字
    bindingwords = "'%"+keywords+"%'"  # 字串串接
    query = '''
    ...
    return render_template('show_data.html', vc_id=result3)
